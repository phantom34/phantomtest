package test.phantom.com.p90.widget.irecyclerview.widget.header;
...
import test.phantom.com.p90.widget.irecyclerview.RefreshTrigger;
...
public class CustomRefreshHeaderView extends RelativeLayout implements RefreshTrigger {
    ...
    public CustomRefreshHeaderView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        imgLoading = (ImageView) findViewById(R.id.img_loading);
        for (int i = 1; i <= 14; i++) {
            int id = getResources().getIdentifier("loading" + i, "drawable", context.getPackageName());
